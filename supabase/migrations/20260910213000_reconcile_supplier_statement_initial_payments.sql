-- Reconcile supplier statement running balance with purchase-time payments.
-- Read-only function replacement; no business data is modified.
...
BEGIN
  ...
  WITH events AS (
    ...
    SELECT
      ...
      v_invoice_time_paid,
      'invoice_time'::text,
      'Aggregate payments captured when purchase invoices were created'::text
