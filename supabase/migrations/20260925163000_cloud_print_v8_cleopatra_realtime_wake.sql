-- Extend V8 Realtime wake to Cleopatra while preserving Smouha unchanged.
-- Forward-only and branch-scoped. Does NOT modify cloud print queue RPCs,
-- printer routing, payloads, receipt rendering, or agent executables.
...
USING (
  branch_id IN (
    '19c3fd23-d784-455b-8840-f4f2ac619651'::uuid, -- Smouha (existing)
