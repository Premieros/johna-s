-- OPTIONAL V8 wake signal.
-- This is intentionally NOT under supabase/migrations.
-- Do not apply to Production until V8 local form tests are accepted.
--
-- It does NOT change the frozen V7 RPC signatures or queue state machine.
-- It adds a tiny branch-level sequence row used only to wake V8 through
-- Supabase Realtime, avoiding high-frequency claim polling.
...
USING (
  branch_id = '19c3fd23-d784-455b-8840-f4f2ac619651'::uuid
...
FOR EACH ROW
WHEN (NEW.branch_id = '19c3fd23-d784-455b-8840-f4f2ac619651'::uuid)
