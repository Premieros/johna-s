  ...
  const pending: WorkAuthorizationRecord[] = [
    {
      ...
      person: { userId: 'preview-user-1', fullName: 'أحمد محمد', roleLabel: 'كابتن أوردر' },
      status: 'pending',
    ...
    },
    {
      ...
      branchId: first.id,
      branchName: first.name,
      person: { userId: 'preview-user-2', fullName: 'محمود حسن', roleLabel: 'كاشير' },
      status: 'pending',
  ...
  const active: WorkAuthorizationRecord[] = [
    {
      ...
      branchId: first.id,
      branchName: first.name,
      person: { userId: 'preview-user-3', fullName: 'منى علي', roleLabel: 'كابتن أوردر' },
      status: 'approved',
    ...
    },
    {
      ...
      person: { userId: 'preview-user-4', fullName: 'يوسف سامي', roleLabel: 'كاشير' },
      status: 'approved',
  ...
  const history: WorkAuthorizationHistoryEntry[] = [
    {
      ...
      branchId: first.id,
      branchName: first.name,
      person: { userId: 'preview-user-5', fullName: 'سارة خالد', roleLabel: 'كابتن أوردر' },
      kind: 'rejected',
