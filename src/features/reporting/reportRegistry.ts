...
export const REPORT_CATEGORIES: Record<ReportCategory, { title: string; titleEn: string; icon: string; order: number }> = {
  ...
  manufacturing_costing: { title: 'المكونات والتكلفة', titleEn: 'Components & Costing', icon: 'Package', order: 4 },
...
export const REPORT_REGISTRY: ReportDefinition[] = [
  ...
  },
  {
    ...
    description: 'كمية كل مكون مستهلكة من تشغيل المبيعات',
    descriptionEn: 'Raw materials consumed by sales operations',
    icon: 'Factory',
    permissions: ['reports.view', 'reports.costing'],
  ...
  },
  {
    ...
    description: 'المكونات الأكثر استهلاكاً من تشغيل المبيعات',
    descriptionEn: 'Most consumed raw materials from sales operations',
    icon: 'BarChart3',
    permissions: ['reports.view', 'reports.costing'],
    filterDimensions: ['warehouse', 'product', 'category'],
    dateDriven: true,
  ...
  },
  {
    ...
    category: 'inventory',
    title: 'حركة واستهلاك الخامات',
    titleEn: 'Raw Material Consumption',
    description: 'رصيد أول المدة والمشتريات والاستهلاك ورصيد آخر المدة لكل خامة',
    descriptionEn: 'Opening stock, purchases, consumption and closing stock per raw material',
    icon: 'Layers',
    permissions: ['reports.view', 'reports.costing'],
    filterDimensions: [],
    dateDriven: true,
    deepLinkKey: 'raw_material_consumption',
  },
  {
    key: 'raw_material_current_cost',
    category: 'inventory',
    title: 'تكلفة الخامات الحالية',
    titleEn: 'Current Raw Material Cost',
    description: 'الكمية الحالية وقيمة طبقات FIFO المتبقية وآخر تكلفة معتمدة',
    descriptionEn: 'Current quantity, residual FIFO value and latest authoritative cost',
    icon: 'Package',
    permissions: ['reports.view', 'reports.costing'],
    filterDimensions: [],
    dateDriven: false,
    deepLinkKey: 'raw_material_current_cost',
  },
  {
    key: 'raw_material_financial',
    category: 'financial',
    title: 'التقرير المالي للخامات والمبيعات',
    titleEn: 'Raw Material Financial Report',
    description: 'أرصدة ومشتريات ومبيعات واستهلاك وقيمة مخزون آخر المدة في تقرير مالي موحد',
    descriptionEn: 'Unified opening, purchases, sales, consumption and closing raw inventory values',
    icon: 'BarChart3',
    permissions: ['reports.view', 'reports.financial'],
    filterDimensions: [],
    dateDriven: true,
    deepLinkKey: 'raw_material_financial',
  },
  {
    key: 'sales_component_reconciliation',
    category: 'manufacturing_costing',
    title: 'مطابقة المبيعات مع استهلاك المكونات',
    titleEn: 'Sales vs Component Consumption',
    description: 'يقارن الاستهلاك النظري من الكميات المباعة ومكونات المنتجات مع الاستهلاك الفعلي المسجل في دفتر المخزون',
    descriptionEn: 'Compares theoretical sold-product BOM consumption with authoritative inventory-ledger consumption',
    icon: 'BadgeCheck',
    permissions: ['reports.view', 'reports.costing'],
    filterDimensions: [],
    dateDriven: true,
    deepLinkKey: 'sales_component_reconciliation',
  },
  {
    key: 'daily_closing_range',
    category: 'financial',
    title: 'حركة الأيام وطرق الدفع',
    titleEn: 'Daily Closing & Payments',
    description: 'ملخص يومي لفترة مفتوحة بنفس منطق إغلاق اليوم مع توزيع طرق الدفع',
    descriptionEn: 'Daily period summary using the day-closing source of truth with payment split',
    icon: 'CalendarDays',
    permissions: ['reports.view', 'reports.financial'],
    filterDimensions: [],
    dateDriven: true,
    deepLinkKey: 'daily_closing_range',
  },
  {
