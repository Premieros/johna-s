...
export const inventory = {
  ...
  createStockCount(p: { p_branch_id: string; p_warehouse_id: string; p_count_type: string; p_notes: string | null; p_items: StockCountInputItem[] | null }): ApiResult<RpcResult & { stock_count_id?: string; count_number?: string; items_added?: number }> { return rpc('create_stock_count', p); },
  ...
  addRawStockCountItem(p: { p_stock_count_id: string; p_raw_material_id: string; p_counted_quantity?: number | null; p_reason?: string | null }): ApiResult<RpcResult> { return rpc('add_stock_count_raw_material', p); },
  updateRawStockCountItem(p: { p_stock_count_id: string; p_raw_material_id: string; p_counted_quantity: number | null; p_reason?: string | null }): ApiResult<RpcResult> { return rpc('update_stock_count_raw_material', p); },
  removeRawStockCountItem(p: { p_stock_count_id: string; p_raw_material_id: string }): ApiResult<RpcResult> { return rpc('remove_stock_count_raw_material', p); },
