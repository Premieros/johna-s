...
export const accounting = {
  ...
  getEmployeeReceivableBalances(p: { p_branch_id: string; p_as_of: string }): ApiResult<ArAgingRow[]> { return rpc('get_employee_receivable_balances', p); },
  ...
  receiveEmployeeReceivablePayment(p: { p_customer_id: string; p_branch_id: string; p_amount: number; p_payment_method: string; p_notes: string | null }): ApiResult<RpcResult> { return rpc('receive_employee_receivable_payment', p); },
