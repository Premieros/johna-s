...
## PR #357 checkpoint — Smouha Print Agent V8.1.1

- Scope: Smouha-only Print Agent V8.1.1 isolated build for Realtime verification.
- Carries the verified Realtime handshake auth placement fix and readiness handling from PR #352.
- AppId: `PremierSmouhaFormPrintAgentV0811`.
- Assembly: `PremierSmouhaFormPrintAgentV0811`.
- Version: `8.1.1`.
- No Production DB migration.
- No direct main edit.
- No change to frozen cloud print RPC signatures, printer routing, or receipt/kitchen renderer logic beyond the already-reviewed V8 path.
