...
## PR #352 checkpoint — Smouha Print Agent V8.1.1 isolated build

- Scope: version/identity isolation only for the Smouha print agent test build.
- Version: `8.1.1`.
- AppId: `PremierSmouhaFormPrintAgentV0811`.
- Executable assembly: `PremierSmouhaFormPrintAgentV0811`.
- Realtime implementation and print queue RPC behavior are unchanged by this checkpoint.
- Production migration: none.
- Main branch: untouched.
- Build workflow must be Green on the exact PR head before the artifact is handed off.
- Full Verify must be Green on the exact PR head before any merge consideration.
